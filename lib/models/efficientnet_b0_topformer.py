...
class EfficientNet_B0(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('efficientnet_b0', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientnet_b0.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientnet_b0.pth')
