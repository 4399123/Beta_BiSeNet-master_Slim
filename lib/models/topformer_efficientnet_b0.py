...
from .efficientnet_b0_topformer import EfficientNet_B0
import numpy as np
...
class TopFormer_EfficientNet_B0(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_EfficientNet_B0,self).__init__()
...
if __name__ == '__main__':
    topf = TopFormer_EfficientNet_B0()
