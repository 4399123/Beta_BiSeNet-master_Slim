...
from .mambaout_tiny import MambaOut_Tiny
...
class BiSeNetV1_MambaOut_Tiny(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MambaOut_Tiny, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_MambaOut_Tiny(19)
    net.eval()
