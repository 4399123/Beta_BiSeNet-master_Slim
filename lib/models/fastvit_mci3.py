...
class FastVit_Mci3(nn.Module):
    def __init__(self):
        super(FastVit_Mci3, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('fastvit_mci3.apple_mclip2_dfndr2b', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/fastvit_mci3.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/fastvit_mci3.pth')
