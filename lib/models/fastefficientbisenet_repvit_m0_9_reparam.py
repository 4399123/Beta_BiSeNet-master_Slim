...
from .repvit_m0_9 import RepVit_M0_9
...
class FastEfficientBiSeNet_RepVit_M0_9_Reparam(nn.Module):
    """
    ...
    def __init__(self, n_classes, aux_mode='train', use_fp16=False, img_size=(512, 512)):
        ...
        """
        super(FastEfficientBiSeNet_RepVit_M0_9_Reparam, self).__init__()
        self.use_fp16 = use_fp16
        self.aux_mode = aux_mode
        self.img_size = img_size

        # 1. 骨干网络
        self.backbone = RepVit_M0_9()

        # 通道定义 (需根据实际 Backbone 输出调整)
        self.c3_chan = 96  # Stride 8
        self.c4_chan = 192  # Stride 16
        self.c5_chan = 384  # Stride 32
...
if __name__ == "__main__":
    ...
    try:
        ...
        net = FastEfficientBiSeNet_RepVit_M0_9_Reparam(
            n_classes=n_classes,
            aux_mode='train',
