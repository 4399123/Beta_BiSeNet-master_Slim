...
from .rdnet_tiny import RDNet_Tiny
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = RDNet_Tiny()
        self.arm16 = AttentionRefinementModule(744, 256)
        self.arm32 = AttentionRefinementModule(1040, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(1040, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_RDNet_Tiny(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_RDNet_Tiny, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
        self.ffm = FeatureFusionModule(512, 512)
        self.conv_out = BiSeNetOutput(512, 384, n_classes, up_factor=8)
