...
from .fastvit_mci3 import FastVit_Mci3
...
class BiSeNetV1_FastVit_Mci3(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_FastVit_Mci3, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
