...
from .tiny_vit_21m import Tiny_Vit_21m
...
class BiSeNetV1_Tiny_Vit_21m(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_Tiny_Vit_21m, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
