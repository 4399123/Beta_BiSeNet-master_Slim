...
from .repvit_m1_1 import RepVit_M1_1
...
class FastEfficientBiSeNet_RepVit_M1_1(nn.Module):
    def __init__(self, n_classes, aux_mode='train', use_fp16=False, img_size=(512, 512)):
        ...
        self.c3_chan = 128  # Stride 8
        self.c4_chan = 256  # Stride 16
        self.c5_chan = 512  # Stride 32
...
if __name__ == "__main__":
    ...
    try:
        ...
        net = FastEfficientBiSeNet_RepVit_M1_1(n_classes=n_classes, aux_mode='train', img_size=(img_height, img_width))
        net.train()
