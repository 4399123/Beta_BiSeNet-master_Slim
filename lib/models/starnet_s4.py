...
class SatrNet_S4(nn.Module):
    def __init__(self):
        super(SatrNet_S4, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('starnet_s4.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/starnet_s4.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/starnet_s4.pth')
