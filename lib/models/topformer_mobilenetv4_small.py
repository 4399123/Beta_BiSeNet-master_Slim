...
from .mobilenetv4_small_topformer import MobileNetV4_Small
import numpy as np
...
class TopFormer_MobileNetV4_Small(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_MobileNetV4_Small,self).__init__()
...
if __name__ == '__main__':
    topf = TopFormer_MobileNetV4_Small()
