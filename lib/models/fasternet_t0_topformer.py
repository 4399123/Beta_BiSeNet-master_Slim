...
class FasterNet_T0_Top(nn.Module):
    def __init__(self):
        super(FasterNet_T0_Top, self).__init__()
        self.out_indices = [0,1, 2,3]
        self.selected_feature_extractor = timm.create_model('fasternet_t0.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/fasternet_t0.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/fasternet_t0.pth')
