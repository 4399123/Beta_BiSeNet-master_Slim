...
from .hgnetv2_b5 import HGNetV2_B5
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv_avg = ConvBNReLU(2048, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_HGNetV2_B5(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_HGNetV2_B5, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
