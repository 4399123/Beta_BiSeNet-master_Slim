...
from .mobilenetv4_small import MobileNetV4_Small
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MobileNetV4_Small()
        self.arm16 = AttentionRefinementModule(96, 256)
        self.arm32 = AttentionRefinementModule(960, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(960, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_MobileNetV4_Small(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MobileNetV4_Small, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_MobileNetV4_Small(19)
    net.eval()
