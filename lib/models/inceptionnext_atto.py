...
class IncetionNeXt_Atto(nn.Module):
    def __init__(self):
        ...
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/inceptionnext_atto.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/inceptionnext_atto.pth')
