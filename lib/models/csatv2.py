...
class CSATV2(nn.Module):
    def __init__(self):
        super(CSATV2, self).__init__()
        self.out_indices = [1,2, 3,4]
        self.selected_feature_extractor = timm.create_model('csatv2', features_only=True, out_indices=self.out_indices,pretrained=False)
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/csatv2.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/csatv2.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/csatv2.pth')
