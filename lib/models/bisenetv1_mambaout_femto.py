...
from .mambaout_femto import MambaOut_Femto
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MambaOut_Femto()
        self.arm16 = AttentionRefinementModule(192, 256)
        self.arm32 = AttentionRefinementModule(288, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(288, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_MambaOut_Femto(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MambaOut_Femto, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
        self.ffm = FeatureFusionModule(512, 512)
        self.conv_out = BiSeNetOutput(512, 256, n_classes, up_factor=8)
...
if __name__ == "__main__":
    net = BiSeNetV1_MambaOut_Femto(19)
    net.eval()
