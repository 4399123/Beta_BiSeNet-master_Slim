...
if __name__ == "__main__":
    ...
    try:
        ...
        net = FastEfficientBiSeNet_FasterNet_T0(n_classes=n_classes, aux_mode='train', img_size=(img_height, img_width))
        net.train()
