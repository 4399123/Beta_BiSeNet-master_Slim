...
from .fasternet_t0_topformer import FasterNet_T0_Top
import numpy as np
...
class TopFormer_FasterNet_T0(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_FasterNet_T0,self).__init__()
