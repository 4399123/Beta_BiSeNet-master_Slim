...
from .hgnetv2_b0 import HGNetV2_B0
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = HGNetV2_B0()
        self.arm16 = AttentionRefinementModule(512, 256)
        self.arm32 = AttentionRefinementModule(1024, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(1024, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_HGNetV2_B0(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_HGNetV2_B0, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
