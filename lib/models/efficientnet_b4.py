...
class EfficientNet_B4(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('tf_efficientnet_b4.ns_jft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientnet_b4.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/efficientnet_b4.pth')
