...
class RepVit_M0_9(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('repvit_m0_9.dist_450e_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/repvit_m0_9.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/repvit_m0_9.pth')
