...
class FasterNet_T2(nn.Module):
    def __init__(self):
        super(FasterNet_T2, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('fasternet_t2.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)
        try:
            load_checkpoint(self.selected_feature_extractor, '../lib/premodels/fasternet_t2.pth')
        except:
            load_checkpoint(self.selected_feature_extractor, '../premodels/fasternet_t2.pth')
