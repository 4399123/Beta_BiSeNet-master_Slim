...
class MobileNetV4_Small(nn.Module):
    def __init__(self):
        super(MobileNetV4_Small, self).__init__()
        self.out_indices = [1,2, 3,4]
        self.selected_feature_extractor = timm.create_model('mobilenetv4_conv_small.e2400_r224_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/mobilenetv4_small.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/mobilenetv4_small.pth')
        self.conv1x1=ConvBNReLU(960, 320, ks=1, stride=1, padding=0)
