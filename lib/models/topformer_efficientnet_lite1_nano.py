...
class TopFormer_Lite1_Nano(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_Lite1_Nano,self).__init__()
        ...
        self.decode_head = Head(c=96,n_classes=n_classes)
