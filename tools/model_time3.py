...
parse.add_argument('--config', dest='config', type=str, default='../configs/bisenetv1_blueface_repghostnet_080.py',)
parse.add_argument('--weight-path', type=str, default='../pt/bisenetv1_repghostnet_080.pt',)
...
# define model
net = model_factory[cfg.model_type](n_classes=cfg.n_cats, aux_mode='eval')
...
for i in range(200):
    ...
    im = to_tensor(dict(im=im, lb=None))['im'].unsqueeze(0).cpu()
