...
def set_optimizer(model):
    optim =AdamP([{'params':model.conv_out.parameters()},{'params':model.conv_out16.parameters()},{'params':model.conv_out32.parameters()}]
                 ,lr=cfg.lr_start,weight_decay=5e-4,nesterov=True)
    return optim
...
def freeze_encoder(model):
    ...
    for param in model.sp.parameters():
        param.requires_grad = False
